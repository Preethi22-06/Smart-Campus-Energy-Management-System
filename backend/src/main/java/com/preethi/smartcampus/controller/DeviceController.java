...
public long getDeviceCountByStatusAndType(
    ...
    return deviceService.getDeviceCountByStatusAndType(
            status,
            type
    );
} 
...
@GetMapping("/floor/{floorId}/energy/type")
public EnergyResponse getFloorEnergyByType(
        @PathVariable Long floorId,
        @RequestParam String deviceType,
        @RequestParam double hours) {

    return deviceService.getFloorEnergyByType(
            floorId,
            deviceType,
            hours
    );
